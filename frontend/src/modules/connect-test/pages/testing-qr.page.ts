// frontend/src/modules/connect-test/pages/testing-qr.page.ts
export class TestingQrPage {
  
  static getContent(): string {
    return `
      <div class="page-content">
        <div class="page-header">
          <h2>🧪 Testowanie QR Code</h2>
          <p>Wykonuj testy urządzeń identyfikowanych przez QR Code</p>
        </div>
        ...
        <div class="test-layout">
          <div class="device-scan">
            <div class="scan-prompt">
              ...
              <p>Zbliż kod QR urządzenia do skanera</p>
            </div>
          </div>
          ...
          <div class="device-info">
            ...
            <div class="info-grid">
              <div class="info-item">
                <span class="info-label">Kod QR:</span>
                <span class="info-value">DEVICE-PSS-7000</span>
              </div>
              <div class="info-item">
  ...
  static getStyles(): string {
    return `
      ...
      .scan-prompt { display: flex; flex-direction: column; align-items: center; gap: 10px; }
